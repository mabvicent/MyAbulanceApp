...
public class PatientMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private TextView mAmbulanceName, mAmbulancePhone, mAmbulanceCar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAmbulanceCar = (TextView) findViewById(R.id.ambulanceCar);

        mRatingBar = (RatingBar) findViewById(R.id.ratingBar);

        mRadioGroup = (RadioGroup) findViewById(R.id.radioGroup);
        mRadioGroup.check(R.id.Government);
...
//                intent.putExtra("patientOrAmbulance", "Patients");
//                startActivity(intent);
//                return;
//            }
//        });
    ...
    private void getClosestDriver(){
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("ambulancesAvailable");
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!ambulanceFound && requestBol){
                    DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulances").child(key);
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                                ...
                                if(driverMap.get("service").equals(requestService)){
                                    ...
                                    DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulances").child(ambulanceFoundID).child("patientRequest");
    ...
    *-------------------------------------------------------------------*/
    ...
    private void getDriverLocation(){
        ambulanceLocationRef = FirebaseDatabase.getInstance().getReference().child("ambulancesWorking").child(ambulanceFoundID).child("l");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && requestBol){
                    ...
                    if (distance<100){
                        ...
                        Toast toast = Toast.makeText(getApplicationContext(), "Ambulance found", Toast.LENGTH_SHORT);
                    ...
                    mAmbulanceMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("your ambulance").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_car)));
                }
    ...
    *-------------------------------------------------------------------*/
    private void getDriverInfo(){
        ...
        DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulances").child(ambulanceFoundID);
        mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    if(dataSnapshot.child("name")!=null){
                        mAmbulanceName.setText(dataSnapshot.child("name").getValue().toString());
                    }
                    if(dataSnapshot.child("phone")!=null){
                        mAmbulancePhone.setText(dataSnapshot.child("phone").getValue().toString());
                    }
                    if(dataSnapshot.child("car")!=null){
                        mAmbulanceCar.setText(dataSnapshot.child("car").getValue().toString());
                    }
                    if(dataSnapshot.child("profileImageUrl").getValue()!=null){
                        Glide.with(getApplication()).load(dataSnapshot.child("profileImageUrl").getValue().toString()).into(mAmbulanceProfileImage);
                    }
    ...
    private void getHasRideEnded(){
        driveHasEndedRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulances").child(ambulanceFoundID).child("patientRequest").child("patientRideId");
    ...
    private void endRide(){
        ...
        mAmbulanceCar.setText("Destination:");
        mAmbulanceProfileImage.setImageResource(R.mipmap.ic_default_user);
    }
    ...
    *-------------------------------------------------------------------*/
    ...
    boolean getAmbulanceAroundStarted = false;
    List<Marker> markers = new ArrayList<Marker>();
    private void getDriversAround(){
        getAmbulanceAroundStarted = true;
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("ambulancesAvailable");
