                    ...
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        if (child.getKey().equals("patient")){
                            ...
                            if(!customerId.equals(currentUserId)){
                                userDriverOrCustomer = "Ambulances";
                                getUserInformation("Patients", customerId);
                            }
                        }
                        if (child.getKey().equals("ambulance")){
                            ...
                            if(!driverId.equals(currentUserId)){
                                ...
                                getUserInformation("Ambulances", driverId);
    ...
    private void displayCustomerRelatedObjects() {
        ...
        mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                DatabaseReference mDriverRatingDb = FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulances").child(driverId).child("rating");
