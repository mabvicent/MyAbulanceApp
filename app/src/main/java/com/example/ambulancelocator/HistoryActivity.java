...
import com.example.ambulancelocator.historyRecyclerView.HistoryAdapter;
import com.example.ambulancelocator.historyRecyclerView.HistoryObject;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customerOrDriver = getIntent().getExtras().getString("patientOrAmbulance");
        userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        getUserHistoryIds();

        if(customerOrDriver.equals("Ambulances")){
        ...
        historyDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(dataSnapshot.child("patientPaid").getValue() != null && dataSnapshot.child("ambulancePaidOut").getValue() == null){
