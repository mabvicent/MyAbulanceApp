...
public class PatientSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Patients").child(userID);
    ...
    private void saveUserInformation() {
        ...
        if(resultUri != null) {
            ...
            final ProgressDialog waitingdialog = new ProgressDialog(PatientSettingsActivity.this);
